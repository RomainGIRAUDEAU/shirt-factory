...
function Backdrop() {
  ...
  return (
    <AccumulativeShadows ref={shadows} temporal frames={60} alphaTest={0.85} scale={10} rotation={[Math.PI, 0, 0]} position={[0, 0, -0.14]}>
...
function Shirt(props) {
  const snap = useSnapshot(state)
  const texture = useTexture(snap.decal ?? "/wp-content/uploads/2019/03/image-attractive-960x540.jpg")
